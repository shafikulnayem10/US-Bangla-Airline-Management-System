...
public abstract class Homepage extends JFrame {
    ...
    protected JLabel logoLabel, airPlaneIconLabel, importantTextLabel, messageLabel, footerLabel, backgroundLabel;
    ...
    public Homepage(String currentUsername) {
        ...
        ImageIcon backgroundImage = new ImageIcon("src/JavaPackages/Images/AirPlanePic.jpg");
        Image scaledImage = backgroundImage.getImage().getScaledInstance(1920, 1080, Image.SCALE_SMOOTH);
